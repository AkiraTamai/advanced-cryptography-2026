...
この README では、課題を GitHub で提出する方法を説明します。Git に慣れていない方も、上から順に一つずつ進めれば提出できます。

- 初めて提出する方は、[「1. 初回だけ行う準備」](#1-初回だけ行う準備)から進めてください。
...
```text
初回の準備 → 課題用の branch を作る → 解答とテスト → commit と push → Pull Request → CI
```
